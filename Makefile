...
build: ## Build the cocoon-macos binary
	CGO_ENABLED=0 go build -ldflags "$(GO_LDFLAGS)" -o cocoon-macos .
...
clean: ## Remove build artifacts, coverage files, and test cache
	rm -f cocoon-macos cocoon-macos-linux-* cocoon-macos-darwin-*
	rm -rf bin/ dist/
...
help: ## Show this help message
	@echo "cocoon-macos Makefile targets:"
	@echo ""
